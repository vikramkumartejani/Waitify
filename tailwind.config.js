  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'header-inner-shadow': 'inset -2px -2px 4px 0px  rgb(250, 251, 255), inset 2px 2px 4px 0px rgba(0, 125, 252, 0.15)',
        'header-inner-shadow-dark': 'inset 2px -2px 4px 0px rgb(10, 12, 18), inset 2px 2px 4px 0px rgba(41, 88, 136, 0.25)',
