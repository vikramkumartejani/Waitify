...
const Hero = () => {
    return (
        <section id='hero' className='py-[100px] md:py-[140px] px-5 space-y-6 md:space-y-7'>
            {/* Logo  */}
            ...
            <div className='space-y-[10px] max-w-[360px] md:max-w-full mx-auto'>
                ...
                <p className='max-w-[560px] w-full mx-auto text-[#4d4d4d] dark:text-white/90 text-sm md:text-lg text-center'>
                    Say goodbye to chaos and hello to efficiency. Nexora is your ultimate productivity partner, built to help teams work smarter, not harder.
                </p>
            </div>
            ...
            <div className='hero-box py-6 md:py-[50px] px-6 md:px-[100px] max-w-[330px] md:max-w-[800px] w-full mx-auto flex flex-col gap-[18px] md:gap-7 rounded-[45px] md:rounded-[50px]'>
                <div>
                    ...
                    <p className='text-[#4d4d4d] text-sm md:text-lg text-center'>
                        Be the first to experience Nexora. Join the waitlist today for early access and updates.
                    </p>
                </div>

                <form className='space-y-5 max-w-[400px] w-full mx-auto'>
                    <div className="rounded-full h-full input-shadow flex items-start p-[2px] relative w-full">
                        <div className="custom-css rounded-full w-full">
                            <input
                                type="email"
                    ...
                    <div className='hero-form-btn w-fit mx-auto'>
                        <button className='text-center py-3 px-6 text-[#4d4d4d] text-sm md:text-lg w-fit mx-auto hover:text-[#007dfc] transition-all duration-300'>Join</button>
                    </div>
                </form>
            </div>
