    ...
    return (
        <>
            <div className="overflow-visible p-[5px] relative">
                ...
                <div className=" rounded-[50px] bg-custom-white dark:bg-gray-800 transform-none overflow-hidden relative py-[10px] px-[24px] shadow-section-title-inside dark:shadow-section-title-inside-dark">
